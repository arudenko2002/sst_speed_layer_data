...
bq rm umg-swift:consumption_speedlayer_staging.transactions_current

#create new transactions table
bq mk --time_partitioning_type=DAY umg-swift:consumption_speedlayer_staging.transactions_current
