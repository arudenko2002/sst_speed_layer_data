...
inner join `$SST_SOURCE_DATASET.$TABLE_NAME_DAY` $ALIAS_DAY on DATE(pt._PARTITIONTIME) = $ALIAS_DAY.day AND
cast(pt.period as int64) = $ALIAS_DAY.${PARENT_PERIOD_COLUMN}
