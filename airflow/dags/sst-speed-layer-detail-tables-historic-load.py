...
dag = createDag('sst-speed-layer-detail-tables-historic-load')



t_increase_bt_node_size = increaseBTClusterSize(dag)

t_decrease_bt_node_size = decreaseBTClusterSize(dag)

t_load_aggregate_artist = createDataflowOprTask('load-aggregate-artist', 'ARTIST', stage_load, '14000101', '15000211', historic_start_date, historic_end_date, bt_table_name_artist, df_startup_worker_node, dag)
t_load_aggregate_project = createDataflowOprTask('load-aggregate-project', 'PROJECT', stage_load, '14000101', '15000211', historic_start_date, historic_end_date, bt_table_name_project, df_startup_worker_node, dag)
t_load_aggregate_track = createDataflowOprTask('load-aggregate-track', 'TRACK', stage_load, '14000101', '15000703', historic_start_date, historic_end_date, bt_table_name_track, df_startup_worker_node, dag)
t_load_aggregate_isrc = createDataflowOprTask('load-aggregate-isrc', 'ISRC', stage_load, '14000101', '15000211', historic_start_date, historic_end_date, bt_table_name_isrc, df_startup_worker_node, dag)
t_load_aggregate_album = createDataflowOprTask('load-aggregate-album', 'ALBUM', stage_load, '14000101', '15000211', historic_start_date, historic_end_date, bt_table_name_album, df_startup_worker_node, dag)



t_increase_bt_node_size >> t_load_aggregate_artist >> t_load_aggregate_project >> t_load_aggregate_track >> t_load_aggregate_isrc >> t_load_aggregate_album >> t_decrease_bt_node_size
