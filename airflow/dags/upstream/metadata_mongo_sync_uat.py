...
# DAG configuration
start_date = datetime(2017, 11, 15, 15, 0, 0, tzinfo=pytz.utc)
...
# declare DAG
dag = DAG('metadata_mongo_sync_uat',
...
trigger_next = BashOperator(
        task_id = 'trigger_mongo_prod_sync',
        bash_command = 'airflow trigger_dag \'metadata_mongo_sync_prod\' -e \'{{ ds }}\'',
        dag = dag
)
